...
public class OrderServiceImpl implements OrderService {
	 ...
	 */
	@Override
	public List<Orders> selectQuickOrder(String userId) throws SQLException, AddException, NotFoundException {
		List<Orders> list = orderDAO.selectQuickOrder(userId);
	...
	public List<Orders> selectOrdersByUserId(String userId) throws SQLException, NotFoundException {
		...
		if (list == null || list.isEmpty())
			throw new NotFoundException(userId + "님의 주문내역이 없습니다.");
		return list;
	}
	...
	public List<Orders> selectAllOrders() throws SQLException, NotFoundException {
		...
		if (list == null || list.isEmpty())
			throw new NotFoundException("주문내역이 없습니다.");
		return list;
	}
